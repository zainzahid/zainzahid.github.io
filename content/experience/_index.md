...
jobs:
  - title: "Full Stack AI Engineer"
    ...
    responsibilities:
      ...
      - "Developed and maintained a Visitor Experience React Native mobile application for both iOS and Android, leveraging modern React architecture functional components, Redux Toolkit, and modern state management patterns implementing engagement features including digital ticketing, personalized itineraries, interactive maps, real-time schedules,, live webcam streaming, push notifications, analytics, and managing iOS/Android releases through the Expo EAS build and deployment pipeline."
      ...
      - "Proactively identifying opportunities for performance enhancements while maintaining expertise in current LLM technologies and prompt engineering methodologies (Tree of Thoughts, Constitutional AI etc.)"
      ...
      - "Creating and executing AI roadmaps that leverage the latest advancements in multi-model AI systems and industry specific models."
